...
function incrustar_hoja_estilos_comision() {
    var hoja_estilos_url =
        '<?php echo get_site_url() . '/wp-content/themes/spotify/assets/modulos/modulo-playlists/modulo-playlists.css';?>';
...
<section class="row m-5">
    <h2 class="text-light">Playlists de Spotify</h2>
        ...
        $args = array(
            ...
            'tax_query' => array (
                array (
                    ...
                    'terms' => 'de-spotify', //nombre del termino creado en wp
                ),
            ),
        );
